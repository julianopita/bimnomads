...
<div class="middle-div-index">
	...
	<a href="main1.php"><img src="images/arrow_left.png" align="left"/></a>
	</div>
	<form action="forum/comment_post.php" method="POST">
		<span class="comment">
		   <textarea class="input-comment" name="commentary" id="commentary" required="required" placeholder="comente na conversa (máximo de 200 caracteres)"></textarea><br/>
		   <?php 
		   
		   $_SESSION['id_discussion']=$_GET['id_discussion'];?>
		     </span>

...
export class Address {
	static getApiAddress() {
		...
		if (pathname.length > 16 && pathname.indexOf("http://192.168.2.120:8080/bimserver/apps/bimsurfer3/") != -1) {
			...
			return href.substring(0, href.indexOf("http://192.168.2.120:8080/bimserver/apps/bimsurfer3/"));
		} else {
			// Return a default

...
{
  Print '<script>alert("Você precisa estar registrado para postar comentários. Clique em Iniciar sessão para ser diecionado para a página de registro");</script>'; // Prompts the user
...
<div class="versions_left"><img src="images/versao-2-100x100.png" width="50px" title="versão 2" align="left"></a></div>
	<div class="versions_left">VERSÃO2<br>versão com maior área construída e espaços diversos</div>
...
<!--discussion frame. In future versions migrate the php and jscript to separate files-->
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 2"); // SQL Query
...
<!--like dislike system-->
 ...
 <div id="viewer" class="versions-elements-center" style="position: relative;">
    ...
    <canvas id="canvas" style="width:550px; height:350px; border:1px solid #000000; position: absolute; left: 0; top: 0; z-index: 1; opacity:0.90"></canvas>
    <canvas id="2dcanvas" style="width:550px; height:350px; border:1px solid #000000;position: absolute; left: 0; top: 0; z-index: 0;"></canvas>
        <script type="text/javascript">
...
<div class="fotorama"
  ...
  <img src="images/gallery/testproject/01.jpg">
  <img src="images/gallery/testproject/02.jpg">
  <img src="images/gallery/testproject/03.jpg">
  <img src="images/gallery/testproject/04.jpg">

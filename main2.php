...
<div class="header-div7">
  ...
  <?php include 'header_logo.php' ?>
   ...
   <div class="header-icons-right"><img src="images/salas_thumbs.png" width="50px" title="salas de aula" align="right"></a></div>
...
<div class="versions-div-grid">
 <div class="versions-elements-left">
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, relation, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 2 AND project_id = 2"); // SQL Query
...
<form name="discussion" action="forum/post_comment.php" method="POST">
    <span id=discbox>
       <textarea data-ls-module="charCounter" maxlength="200" class="input-comment" name="discussion" id="discussion" required="required" placeholder="contribua para o projeto das salas de aula (máximo de 200 caracteres)"></textarea>
    <button class="button" type="submit" name="submit" id="discussion"><img src="images/arrow_right.png"></button> <br/>
      </form>
      <script>
        const discbox = document.getElementById('discbox');
...
<div class="fotorama"
  ...
  <img src="images/2/02_02.png">
  <img src="images/2/02_01.png">

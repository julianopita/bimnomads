...
<div class="header-div7">
  ...
  <div class="header-icons-left"><a href="calendar.php"><img src="images/calendar-100x100.png"  width="50" align="left"/></a></div>
   ...
   <div class="header-icons-text"><br>Voronoi</div>


<div class="header-icons-right"><a href="main1.php"><img src="images/quadrado triangulos.png" width="50px" title="versão 1" align="left" style="opacity:0.2"></a></div>
   <div class="header-icons-right"><img src="images/quadrado voronoi.png" width="50px" title="versão 2" align="right"></div>
   <div class="header-icons-right"><a href="main3.php"><img src="images/quadrado quadrados.png" width="50" title="versão 3" align="right" style="opacity:0.2"></a></div>
 </div>
...
<div class="versions-div-grid">
    ...
    <script>
    $("#versions-elements-left").animate({scrollTop: 0 }, "fast");
    </script> 
    <?php
      session_start();
      $_SESSION['project_id']=3;
      ...
      $query = mysql_query("SELECT id_discussion, user_name, relation, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 2 AND project_id = 3"); // SQL Query
...
<form name="discussion" action="forum/post_comment.php" method="POST">
    <span id=discbox>
       <textarea data-ls-module="charCounter" maxlength="200" class="input-comment" name="discussion" id="discussion" required="required" placeholder="dê sua opinião sobre o Voronoi (máximo de 200 caracteres)"></textarea>
...
<div class="fotorama"
  ...
  <img src="images/2/voronoi_fallback.png">

...
<div class="header-div7">
  ...
  <div class="header-icons-left"><a href="calendar.php"><img src="images/calendar-100x100.png"  width="50" align="left"/></a></div>
   ...
   <div class="header-icons-left"><a href="versoes.php"><img src="images/versoes.PNG"  width="50"  align="right" /></a></div>
   <div class="header-icons-text"><br>Boxes</div>


<div class="header-icons-right"><a href="main1.php"><img src="images/quadrado triangulos.png" width="50px" title="triângulos" align="left" style="opacity:0.2"></a></div>
   ...
   <div class="header-icons-right"><img src="images/quadrado quadrados.png" width="50" title="quadrados" align="right"></a></div>
 </div>
...
<div class="versions-div-grid">
	...
	<div id="discussion" class="versions-elements-left">
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, relation, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 3 AND project_id = 3"); // SQL Query
...
<form name="discussion" action="forum/post_comment.php" method="POST">
    <span id=discbox>
       <textarea data-ls-module="charCounter" maxlength="200" class="input-comment" name="discussion" id="discussion" required="required" placeholder="dê sua opinião sobre o Boxes (máximo de 200 caracteres)"></textarea>
...
<div class="fotorama"
  ...
  <img src="images/3/boxes_fallback.png">

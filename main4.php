...
<div class="header-icons-center"><p><br><br>VERSÃO 1</p></div>

	

  
<div class="header-icons-right"><img src="images/versao1.png" width="50px" title="versão 1" align="left"></a></div>
...
<!--discussion frame. In future versions migrate the php and jscript to separate files-->
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 4"); // SQL Query
...
<div class="fotorama"
  ...
  <img src="images/3/3-1.jpg">
  <img src="images/3/3-2.jpg">
  <img src="images/360/360_Local_3.jpg">

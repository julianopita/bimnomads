...
<div class="header-icons-center"><p><br><br>VERSÃO 3</p></div>
...
<div class="header-icons-right"><a href="main5.php"><img src="images/versao2.png" width="50px" title="versão 2" align="right" style="opacity:0.2"></a></div>
<div class="header-icons-right"><img src="images/versao3_225x225.png" width="50" title="versão 3" align="right"></div>
...
<!--discussion frame. In future versions migrate the php and jscript to separate files-->
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, date_time, discussion, likes, dislikes FROM discussion WHERE tag_version = 6"); // SQL Query
...
<div class="fotorama"
  ...
  <img src="images/1/1-1.jpg">
  <img src="images/1/1-2.jpg">
  <img src="images/1/1-3.jpg">
  <img src="images/1/1-4.jpg">
  <img src="images/360/360_Local_1.jpg">

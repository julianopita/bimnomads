...
<!--discussion frame. In future versions migrate the php and jscript to separate files-->
    ...
    <?php
      ...
      $query = mysql_query("SELECT id_discussion, user_name, relation, date_time, discussion, likes, dislikes FROM discussion WHERE project_id=2"); // SQL Query
        ...
        //shows discussions
         echo "{$row['user_name']} | {$row['relation']} | {$date_time_discussion} | "?>  
<?php

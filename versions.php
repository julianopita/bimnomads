...
<div class="header-div6">
  ...
  <div class="header-icons-left"><a href="calendar.php"><img src="images/calendar-100x100.png"  width="50" align="left"/></a></div>
   ...
   <div class="header-icons-text"><br>projetos</div>
...
<span><a href="main3.php" class="darken"><img src="images/logo apae.png" width="100" height="100" float="left"/><span class="mouseover-text"><br><br><br>briefing</span></span></a>

<span><a href="main1.php" class="darken"><img src="images/externo_thumbs.png" width="100" height="100" float="left"><span class="mouseover-text"><br><br>área externa e acesso de veículos</span></span></a></a>
		
<span><a href="main2.php" class="darken"><img src="images/salas_thumbs.png" width="100" height="100" float="left"/><span class="mouseover-text"><br><br>ampliação das salas de aula</span></span></a>
		

<div class="arrow-right">
<a href="main3.php"><img src="images/arrow_right_black.png" align="left"/></a>
</div>
</div>
 	
	<!--icones características-->
<div class="middle-div-projects-icons">
 <span class="icon-projects"> briefing</span><span class="icon-projects"> área externa</span><span class="icon-projects"> salas de aula</span>
